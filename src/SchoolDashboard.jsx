                ...
                <div style={{ marginTop: 14, paddingTop: 14, borderTop: "1px solid #2d2d4a" }}>
                  ...
                  {s.medianHomePrice > 0 && <div style={{ marginTop: 10, background: "rgba(139,92,246,0.06)", border: "1px solid rgba(139,92,246,0.15)", borderRadius: 8, padding: 12 }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 8 }}>
                      {[0.82, 0.97, 1.08, 1.22].map(function(mult, idx) { var p = Math.round(s.medianHomePrice * mult / 1000) * 1000; var beds = [3, 4, 4, 5][idx]; var sqft = [1800, 2400, 2800, 3500][idx]; return React.createElement("div", {key: idx, style: {background: "rgba(30,30,56,0.6)", borderRadius: 6, padding: "8px 10px"}}, React.createElement("div", {style: {fontSize: 13, fontWeight: 700, color: "#a78bfa"}}, "$" + Math.round(p/1000) + "K"), React.createElement("div", {style: {fontSize: 10, color: "#888"}}, beds + "bd | " + sqft.toLocaleString() + " sqft")); })}
                    </div>
