...
const SCHOOLS = [
  ...
  },
  {
    ...
    yourZoned: false, admissionChance: 20, distance: "5.0 mi (est.)",
  ...
  },
  {
    ...
    yourZoned: true, admissionChance: 100, distance: "1.5 mi from your address",
  ...
  },
  {
    ...
    yourZoned: false, admissionChance: 20, distance: "12 mi",
                ...
                <div style={{ marginTop: 14, paddingTop: 14, borderTop: "1px solid #2d2d4a" }}>
                  ...
                  <div style={{ marginTop: 10, background: "rgba(139,92,246,0.06)", border: "1px solid rgba(139,92,246,0.15)", borderRadius: 8, padding: 12 }}>
                    ...
                    <div style={{ marginTop: 8, fontSize: 10 }}>
                      ...
                      <a href={"https://www.redfin.com/city/" + (s.address.includes("Holly Springs") ? "8242/NC/Holly-Springs" : s.address.includes("Apex") ? "387/NC/Apex" : s.address.includes("Cary") ? "35713/NC/Cary" : s.address.includes("Fuquay") ? "6517/NC/Fuquay-Varina" : "35711/NC/Raleigh")} target="_blank" rel="noopener noreferrer" style={{ color: "#60a5fa", textDecoration: "none" }}>Redfin Listings</a>
                    </div>
                  </div>
                  )}
                </div>
